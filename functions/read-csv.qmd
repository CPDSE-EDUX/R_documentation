...
```{webr-r}
read_lines("dissolution_data_raw.csv", n_max = 3)
```
:::
...
data <- read_csv("dissolution_data_raw.csv")
...
read_csv("dissolution_data_raw.csv", skip = 2)
read_csv("dissolution_data_raw.csv", skip = 2, skip_empty_rows = FALSE)
```
</div>
</details>
...
read_csv("dissolution_data_raw.csv")
