...
<div class="example-body">
The [example file](https://raw.githubusercontent.com/CPDSE-EDUX/R_documentation/refs/heads/main/assets/data/dissolution_data_raw.csv) also has a fully blank row between tablet 1 and tablet 2 — common after copy-pasting from Excel. By default `skip_empty_rows = TRUE` drops it automatically. Set it to `FALSE` if you need to keep it (it shows up as a row of `NA`s).
...
read_csv("https://raw.githubusercontent.com/CPDSE-EDUX/R_documentation/refs/heads/main/assets/data/dissolution_data_raw.csv", skip = 2, skip_empty_rows = FALSE)
```
</div>
</details>
