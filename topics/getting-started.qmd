...
4. [Data Handling](../topics/data-handling.qmd) — import spreadsheets and tidy real data.
5. [Pipe Operator (%>%)](../topics/pipe-operator.qmd) — chain steps into readable pipelines.
6. [Math Operations](../topics/math-operations.qmd) — arithmetic and math functions.

**Analyse and present**

7. [Descriptive Statistics](../topics/descriptive-stats.qmd) — summarise your data.
8. [Visualization](../topics/visualization.qmd) — plot with ggplot2.
9. [Linear Regression](../topics/linear-regression.qmd) — fit and interpret straight-line models.
